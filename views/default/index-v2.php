        ...
        <nav role="navigation" class="navbar navbar-default">
            ...
            <div id="navbar-collapse" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li role="presentation"><a href="javascript:;">当前功能模块：<?php echo $actionDoc->getRootModule()->getName();?></a></li>
                </ul>
    ...
    <div class="row">
        ...
        <div id="descPanel" class="col-md-5">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <?php
                            $paramDataList = $actionDoc->getParamDescriptionList();
                            foreach ($paramDataList as $paramItem) {
                        ?>
                                <tr>
                                    <th scope="row"><?php echo $paramItem["key"];?></th>
                                    <td><?php echo $paramItem["type"];?></td>
                                    <td width="120px;"><?php echo $paramItem["brief"];?></td>
                                    <td><?php echo $paramItem["defaultValue"];?></td>
                                    <td width="100px;"><?php echo $paramItem["detail"];?></td>
                                </tr>
                        <?php
                            }
                        ?>
                    ...
                    <?php
                        $paramDetailList = $actionDoc->getParamDetail();
                        foreach ($paramDetailList as $parentDataKey=> $paramList) {
                    ?>
                            <b><?php echo $parentDataKey;?></b>
                    <table class="table table-bordered">
                        <thead>
                        <tr>
                            <th>参数</th>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php
                    $paramDetailList = $actionDoc->getReturnDataDetail();
                    foreach ($paramDetailList as $parentDataKey=> $paramList) {
                        ?>
                        <b><?php echo $parentDataKey;?></b>
                        <table class="table table-bordered">
